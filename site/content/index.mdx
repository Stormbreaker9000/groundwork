...
- **[The design stage](/guide/design-stage/)** — the architecture interview,
  and the six things the requirement set does not carry.
- **[Gates and validators](/guide/gates/)** — what each checker owns, and what
  to do when one exits non-zero.
- **[Troubleshooting](/guide/troubleshooting/)** — specific failures, symptom
  first.
...
- **[Reference](/guide/reference/rules/)** — content rules, frontmatter
  fields, and the agent roster, generated from the tools themselves.
