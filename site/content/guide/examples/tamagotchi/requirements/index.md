...
The requirements stage of the `tamagotchi` worked example: 26 atomic artifacts published across 4 pages, exactly as the pipeline wrote them.

- **[Functional requirements](/guide/examples/tamagotchi/requirements/functional/)** — 12 functional requirements.
