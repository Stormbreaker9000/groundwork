...
The requirements stage of the `gdpr` worked example: 21 atomic artifacts published across 4 pages, exactly as the pipeline wrote them.

- **[Functional requirements](/guide/examples/gdpr/requirements/functional/)** — 3 functional requirements.
